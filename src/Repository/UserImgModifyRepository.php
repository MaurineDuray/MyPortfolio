...
/**
 * @extends ServiceEntityRepository<UserImgModify>
 *
...
class UserImgModifyRepository extends ServiceEntityRepository
{
    ...
    public function save(UserImgModify $entity, bool $flush = false): void
    {
    ...
    public function remove(UserImgModify $entity, bool $flush = false): void
    {
